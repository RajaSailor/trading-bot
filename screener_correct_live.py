"""
LIVE SCREENER - CORRECT MarketFeed Implementation
5-Min Candle Breakout Strategy using DhanHQ MarketFeed
File: screener_correct_live.py
"""
...
print(f"""
{'='*90}
📊 LIVE SCREENER - 5 MIN BREAKOUT STRATEGY (CORRECT DHANHQ API)
{'='*90}
[INFO] Configuration:
...
Strategy: Most Recent RED/GREEN Candle Breakout
  - Real-time tick data from DhanHQ MarketFeed
  - Scans every tick for breakout conditions
...
def process_tick(tick):
    ...
    try:
        ...
        strategies[symbol].add_candle(
            ...
            timestamp=latest_ticks[symbol]["time"]
        )
        ...
        print(f"[DEBUG] Error processing tick: {e}")
...
def screener_loop():
    ...
    print(f"[INFO] Starting 5-min screener (Real-time tick data)\n")
    ...
    # Format: {"NSE_FNO": ["13", "25"], "MCX_FUT": ["565899"]}
    instruments = {
