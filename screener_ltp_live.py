"""
LIVE SCREENER - LTP BASED (No Candle Data Required)
5-Min Candle Breakout Strategy using Last Traded Price
File: screener_ltp_live.py
"""
...
print(f"""
{'='*90}
📊 LIVE SCREENER - LTP BASED (5 MIN BREAKOUT STRATEGY)
{'='*90}
[INFO] Configuration:
...
Strategy: Most Recent RED/GREEN Candle Breakout (LTP Based)
  - Uses Last Traded Price for real-time data
...
def fetch_ltp(symbol_id, exchange_segment):
    """Fetch Last Traded Price using DhanHQ"""
    try:
...
def screener_loop():
    """Main screener loop using LTP data"""
    ...
    print(f"[INFO] Starting 5-min screener (LTP based, scans every 5 seconds)\n")
    ...
    while True:
        ...
        for symbol, config in symbol_config.items():
            ...
            if quote_data:
                ...
                # Only add candle if price changed (to simulate 5-min updates)
